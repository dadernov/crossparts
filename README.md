...
Все `/api/v1/*` требуют заголовок `X-API-Key` (пары «ключ:тенант» задаются в `CP_API_KEYS`;
пустое значение выключает авторизацию для разработки). Задания изолированы по тенанту.
